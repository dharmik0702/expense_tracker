...
public class ExpenceTransection extends JFrame  {

    private ArrayList<Expence> expenses;  // Declare the list for expenses
    ...
    private JLabel totalLabel;
     ...
     ExpenceTransection() {
        expenses = new ArrayList<>();  // Initialize the list
    ...
    private void addExpense() {
        ...
        if (!description.isEmpty() && !amountText.isEmpty()) {
            try {
                ...
                expenses.add(new Expence(description, amount));  // Create an Expense object and add it to the list
                updateListAndTotal();
